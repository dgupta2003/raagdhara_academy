    ...
    <section className="border-y border-border bg-background py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-4">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/15 text-primary text-sm font-medium tracking-wide">
        ...
        {/* Headline */}
        <h2 className="font-headline text-center text-4xl md:text-5xl font-semibold text-primary mb-4">
          The Raagdhara Student Portal
        </h2>
        <p className="font-body text-center text-lg text-muted-foreground max-w-2xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-card rounded-lg border border-border p-6 shadow-sm">
            ...
            <h3 className="font-headline text-lg font-semibold text-primary mb-2">Track Attendance</h3>
          ...
          <div className="bg-card rounded-lg border border-border p-6 shadow-sm">
            ...
            <h3 className="font-headline text-lg font-semibold text-primary mb-2">Pay Fees Online</h3>
            <p className="font-body text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="bg-card rounded-lg border border-border p-6 shadow-sm">
            ...
            <h3 className="font-headline text-lg font-semibold text-primary mb-2">Always Up to Date</h3>
            <p className="font-body text-sm text-muted-foreground leading-relaxed">
